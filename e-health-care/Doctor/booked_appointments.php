...
<body class="container display-4">
           <h1 class="text-white shadow-lg">Booked Appointments</h1>
...
$edit_doctor_profile_query="select * from doctor join schedule on schedule.d_id=doctor.id join appointment on appointment.sid=schedule.s_id  join user on appointment.pid=user.id where doctor.email='$d_email' and appointment.permission='Approved'";

...
<thead>
<tr>
  <th class="text-center text-dark active"><h2>ID</h2></th>
<th class="text-center text-dark active"><h2>Name</h2></th>
<th class="text-center text-dark active"><h2>E-mail</h2></th>
<th class="text-center text-dark active"><h2>Contact</h2></th>
...
include("connection.php");
 if(isset($_REQUEST["submit"]))
       ...
       $query = "SELECT *
                  ...
                  <th class="text-center"><?php echo $row['contact'] ;?></th>
...
<ul class="pager font-weight-bold text-monospace text-center">
  <li class="previous "><a href="view_admin_home_page.php">Home</a></li>
</ul></div>

...
<nav class="navbar navbar-default navbar-fixed-top">
  <div class="container-fluid ">
    <div class="navbar-header">
      ...
      <a class="navbar-brand text-dark" href="#myPage"><strong>Admin Panel</strong></a>
    <div class="collapse navbar-collapse" id="myNavbar">
      <ul class="nav navbar-nav navbar-right">


<li><a href='display_user.php'>Display All User List</a></li>
<li><a href='doctor_name_display.php'>Display All Doctor's List</a></li>
...
<div id="myCarousel" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner" role="listbox" >
      <div class="item active">
        <img src="../pic/1.jpg" alt="img1" width=100% height="auto" title="Admin Home Page">
    </div></div></div>

...
$sid=$_POST['sid'];
	...
	elseif(empty($pid))
	   ...
	   { $d_query="INSERT INTO appointment(booking_date,booking_time,permission,date,pid,sid)
					...
					echo "<script language='javascript'> alert ('Your Appointment Has Been Send Successfully! Wait until approval by Doctor.')</script>";
          echo "<script language='javascript'>
    window.location = '../users/view_users_appointment.php';
</script>";
...
<h3>Enter Your ID :<?php echo "("; echo   $drow['id'];echo ")"; } ?></h3><br />  <b><input type = "pid" name="pid"/> </b><br /><br /><br />

  <h3> Enter the appointment schedule ID :<?php  echo "("; echo   $row['s_id'];echo ")"; } ?></h3><br />
...
<ul class="pager font-weight-bold text-monospace">
  <li class="center"><a href="../users/view_user_home_page.php">Home</a></li>

...
echo" Name : "; echo $row['f_name']; echo "  " ; echo $row ['l_name']; echo "<br/>  " ;

echo"Email Address :  ";   echo $row['email'];  echo "<br/>  " ;
echo"Contact Number :  ";  echo $row['contact'] ; echo "<br/>  " ;
...
<ul class="pager font-weight-bold text-monospace">
  <li class="previous "><a href="view_user_home_page.php">Home</a></li>
</ul></div>
                 </div>
      </div>
    </div>

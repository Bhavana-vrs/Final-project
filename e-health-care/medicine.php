...
<title>Medicine Department</title>
</head>
<style>
h1{
font-size:50px;
...
<h1 class="text-monocase text-capitalize text-center text-light">General Medicine Department</h1>
...
<ul class="pager font-weight-bold text-monospace">
   ...
   <li class="previous" ><a href="index.php">Home</a></li>
</ul></div>
<?php
	   include 'footer.html';?>
 <script src="https://ajax.googleapis.com/ajax/libs/jquery/3.3.1/jquery.min.js"></script>
